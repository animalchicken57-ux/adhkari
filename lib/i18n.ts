...
const ar: Dict = {
  ...
  "nav.duas": "أدعية",
  "nav.favourites": "المفضّلة",

  "fav.title": "المفضّلة",
  "fav.subtitle": "كل ما حفظته من أدعية ومعلومات وقصص في مكان واحد.",
  "fav.add": "أضف إلى المفضّلة",
  "fav.remove": "أزل من المفضّلة",
  "fav.empty": "لم تحفظ شيئًا بعد. اضغط على ♡ بجانب أي دعاء أو معلومة أو قصة ليظهر هنا.",
  "fav.browse": "تصفّح الأدعية",
  "fav.count": "المحفوظات",
  "fav.clear": "🗑️ مسح كل المفضّلة",
  "fav.clearConfirm": "هل تريد حذف كل المفضّلة؟ لا يمكن التراجع.",
  "fav.note": "تُحفظ المفضّلة داخل هذا المتصفّح على هذا الجهاز فقط، ولا تنتقل إلى أجهزتك الأخرى.",
  "nav.share": "شارك",
  ...
  "qibla.hint": "اسمح بالوصول للموقع والبوصلة، وأمسك الجهاز مستويًا. أدِر جسمك حتى تنطبق إبرة الكعبة 🕋 على العلامة في الجانب الأيمن من الدائرة — عندها تكون مواجهًا للقبلة.",
...
const en: Dict = {
  ...
  "fav.subtitle": "Everything you've saved — du'as, facts and stories — in one place.",
  "fav.add": "Add to favourites",
  "fav.remove": "Remove from favourites",
  "fav.empty": "Nothing saved yet. Tap ♡ next to any du'a, fact or story and it will appear here.",
  "fav.browse": "Browse the du'as",
  "fav.count": "Saved",
  "fav.clear": "🗑️ Clear all favourites",
  "fav.clearConfirm": "Delete all your favourites? This can't be undone.",
  "fav.note": "Favourites are stored in this browser on this device only — they don't follow you to your other devices.",
  "nav.share": "Share",
  "nav.about": "About",
  ...
  "qibla.hint": "Allow location & compass access, and hold the device flat. Turn your body until the 🕋 needle lines up with the marker on the right-hand side of the dial — that is the Qibla.",
